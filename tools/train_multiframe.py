...
def train_all_timeframes():
    # Map: Description -> (DataFile, Suffix)
    # Daily is slightly different (XAUUSD_history.csv, suffix "")
    tasks = [
        {"name": "Daily", "data": "data/XAUUSD_history.csv", "suffix": ""},
        {"name": "4 Hour", "data": "data/XAUUSD_4h.csv", "suffix": "_4h"},
        {"name": "1 Hour", "data": "data/XAUUSD_1h.csv", "suffix": "_1h"},
        {"name": "15 Min", "data": "data/XAUUSD_15m.csv", "suffix": "_15m"},
        {"name": "5 Min", "data": "data/XAUUSD_5m.csv", "suffix": "_5m"},
    ]
    
    # 1. Fetch all data first (Optional, assumes fetch_yfinance_data already ran or handles it)
    # We will assume data fetching is a separate step or user ran it.
